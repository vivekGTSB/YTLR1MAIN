<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.GeofenceManagementPublic" Codebehind="GeofenceManagementPublic.aspx.vb" %>
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <br />
        <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Public Geofence Management</b>
        <br />
        <br />
     ...
     <table style="font-family: Verdana; font-size: 11px; width:762px"  >
        ...
        <tr>
                ...
                <% If Request.Cookies("userinfo")("customrole") <> "transporter" Then%>
                    ...
                    <asp:Button ID="ImageButton2" class="action blue" runat="server" Text="Inactive"
                        ToolTip="Inactive" />
               ...
               <td align="right" valign="middle" >
                    <img src="images/GoogleMaps.gif" alt="Show Vehicles in Google Maps" style="cursor: pointer; vertical-align:middle "
                        onclick="ShowGoogleMaps();" />
                    <img src="images/GoogleEarth.gif" alt="Show Vehicles in Google Earth" style="cursor: pointer; vertical-align:middle "
    ...
    <input type="hidden" id="title" name="title" value="Public Geofences" />

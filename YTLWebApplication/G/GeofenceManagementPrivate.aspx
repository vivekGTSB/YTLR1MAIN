<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.GeofenceManagementPrivate" Codebehind="GeofenceManagementPrivate.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Geofence Management - Private</title>
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <br />
        <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Private Geofence Management</b>
        <br />
        <br />
        ...
        <table style="font-family: Verdana; font-size: 11px;" width="100%">
            <tr>
                <td align="left">
                    <% If Request.Cookies("userinfo")("customrole") = "LFSuperUser" Or Request.Cookies("userinfo")("customrole") = "transporter" Then%>
    ...
    <input type="hidden" id="title" name="title" value="Private Geofence Report" />

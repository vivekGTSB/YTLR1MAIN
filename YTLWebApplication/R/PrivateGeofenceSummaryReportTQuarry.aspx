<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.PrivateGeofenceSummaryReportTQuarry" EnableViewState="false" EnableEventValidation="false" Codebehind="PrivateGeofenceSummaryReportTQuarry.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Transporter Geofence Report</title>
    ...
    <script type="text/javascript">
          ...
          $("#txtEndDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: -180, maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
            ...
            $("#dialog-message").dialog({
             ...
             document.getElementById("mappage").src = "GMapQuarry.aspx?bdt=" + intime + "&edt=" + outtime + "&plateno="+ plateno +"&scode=1&sf=0&r=" + Math.random();
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Transporter Geofence
                Report</b>
            <br />
            <br />
        </div>
                    ...
                    <table style="font-family: Verdana; font-size: 11px;">
                        <tr>
                            <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                <b style="color: White;">&nbsp;Transporter Geofence Report&nbsp;:</b>
                            </td>
                        </tr>
                        <tr>
    ...
    <input type="hidden" id="title" name="title" value="Transporter Geofence Report" />

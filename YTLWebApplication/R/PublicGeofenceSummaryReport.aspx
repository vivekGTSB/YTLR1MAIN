<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.PublicGeofenceSummaryReport" EnableViewState="false" EnableEventValidation="false" Codebehind="PublicGeofenceSummaryReport.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Public Geofence Summary Report</title>
    ...
    <script type="text/javascript">
        ...
        function getWindowHeight() { if (window.self && self.innerHeight) { return self.innerHeight; } if (document.documentElement && document.documentElement.clientHeight) { return document.documentElement.clientHeight; } return document.documentElement.offsetHeight; }
          ...
          $("#txtEndDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: -210, maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
                ...
                $("#mappage").width(getWindowWidth() - 105);
                $("#mappage").height(getWindowHeight() - 105);
            ...
            $("#dialog-message").dialog({
                ...
                modal: true,
                autoOpen: false,
                minWidth: getWindowWidth()-100,
                minHeight: getWindowHeight() - 100
            });
                $(".chzn-select").chosen();
                $(".chzn-select-deselect").chosen({ allow_single_deselect: false });
                $('.chzn-search').find('input[type="text"]')[0].style.width = '206px';

                $(".chzn-select-Uname").chosen();
                $(".chzn-select-Uname-deselect").chosen({ allow_single_deselect: false });
                $('.chzn-search').find('input[type="text"]')[0].style.width = '206px';
  ...
  function fnFeaturesInit() {
    ...
    <script type ="text/javascript" >
        ...
        function AddFavorite() {
            $.ajax({
                type: "POST",
                url: "PublicGeofenceSummaryReport.aspx/ManageFavorite",
                ...
                success: function (response) {
                    ...
                    if (json == "1") {
                        ...
                        window.location.href = "PublicGeofenceSummaryReport.aspx";
                    }
                    else {
                        alert("Error");
                    }
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Public Geofence Summary Report</b>
            <br />
            <br />
        </div>
        <table>
                    ...
                    <table style="font-family: Verdana; font-size: 11px;">
                        <tr>
                            <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                <b style="color: White;">&nbsp;Public Geofence Summary Report &nbsp;:</b>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table style="width: 450px;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="width: 326px">
                                                <asp:DropDownList ID="DropDownList1" CssClass="chzn-select-Uname" runat="server" Width="248px" AutoPostBack="true" >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                         ...
                                         <tr>
                                            <td align="left">
                                                <b style="color: #465AE8;">Geofence Type</b>
                                            </td>
                                            <td>
                                                <b style="color: #465AE8;">:</b>
                                            </td>
                                            <td align="left" style="width: 326px">
                                                <asp:DropDownList ID="ddlgeofencetype" runat="server" AutoPostBack ="true"  Width="248px" OnSelectedIndexChanged="ddlgeofencetype_SelectedIndexChanged" >
                                                 </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left" style="width: 326px">
                                                ...
                                                <asp:DropDownList ID="ddlGeofence" CssClass="chzn-select" runat="server" Width="248px" >
            ...
            <img class="removef" onclick="RemoveFavorite()" title="Remove From Favorite" style="cursor:pointer" src="images/cross_tick.gif" />
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="width: 326px">
                                                 <asp:CheckBox ID="chkinsidereport" runat="server" Text="Show only trucks in Geofences" Font-Bold="True"  />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
    ...
    <input type="hidden" id="title" name="title" value="Geofence Report" />

<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.PTOHistory" EnableViewState="false" EnableEventValidation="false" Codebehind="PTOHistory.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>PTO History Report</title>
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">PTO History Report</b>
            <br />
            <br />
        </div>
        <table>
                    ...
                    <table style="font-family: Verdana; font-size: 11px;">
                        <tr>
                            <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                <b style="color: White;">&nbsp;PTO History Report &nbsp;:</b>
                            </td>
                        </tr>
                        <tr>
    ...
    <input type="hidden" id="title" name="title" value="PTO History Report" />
    </form>
    <div class="demo">

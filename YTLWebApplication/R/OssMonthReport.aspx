<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OssMonthReport.aspx.vb" Inherits="YTLWebApplication.OssMonthReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Monthly Truck Performance Report</title>
    ...
    <script type="text/javascript">
        ...
        function ExcelReport() {
            ...
            document.getElementById("title").value = "Monthly Truck Performance Report : " + document.getElementById("ddlPlants").options[document.getElementById("ddlPlants").selectedIndex].text;
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    <form id="Form1" method="post" runat="server">
        <center>
            <div>
                <br />
                <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Monthly Truck Performance Report</b>
                <br />
                <br />
            </div>
            <table>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp;Monthly Truck Performance Report&nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
    ...
    <form id="excelform" method="get" action="ExcelReport.aspx">
        <input type="hidden" id="title" name="title" value="Monthly Truck Performance Report" />

<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.PTOSummaryReport" EnableViewState="false" EnableEventValidation="false" Codebehind="PTOSummaryReport.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>PTO Summary Report</title>
    ...
    <script type="text/javascript">
		    ...
		    $(function () {
          $("#txtBeginDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: new Date(2013, 2, 1), maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
          });

          $("#txtEndDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: new Date(2013, 2, 1), maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">PTO Summary Report</b>
            <br />
            <br />
        </div>
        <table>
                    ...
                    <table style="font-family: Verdana; font-size: 11px;">
                        <tr>
                            <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                <b style="color: White;">&nbsp;PTO Summary Report &nbsp;:</b>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table style="width: 450px;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="width: 326px">
                                                <asp:DropDownList ID="ddlplate" runat="server" Width="248px" EnableViewState="false"
                                                   >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
    ...
    <input type="hidden" id="title" name="title" value="PTO Summary Report" />
    </form>
    <div class="demo">

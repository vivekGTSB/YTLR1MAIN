<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.VehicleUsageChart" Codebehind="VehicleUsageChart.aspx.vb" %>

<%@ Register TagPrefix="chart" Namespace="ChartDirector" Assembly="netchartdir" %>
<%--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">--%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Vehicle Usage Chart</title>
...
<body>
    ...
    <center>
        <div>
            <div>
                <br />
                <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Vehicle Usage Chart
                </b>
                <br />
                <br />
            </div>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp; Vehicle Usage Chart &nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
    ...
    <input type="hidden" id="title" name="title" value="Vehicle Usage Chart" />
    </form>
</body>
<script type="text/javascript">

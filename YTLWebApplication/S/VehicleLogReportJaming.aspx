<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.VehicleLogReportJaming" Codebehind="VehicleLogReportJaming.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Vehicle Log Report With Jamming</title>
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            $("#txtBeginDate").datepicker({ dateFormat: 'yy/mm/dd', yearRange: '2011:2020', minDate: new Date(2011, 1 - 1, 1), maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
            });

            $("#txtEndDate").datepicker({ dateFormat: 'yy/mm/dd', yearRange: '2011:2020', minDate: new Date(2011, 1 - 1, 1), maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
    ...
    <center>
        <div>
            <br />
             ...
             <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Vehicle Log Report With Jamming</b>
            <br />
            <br />
            <table>
                <tr>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp;Vehicle Log Report With Jamming &nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <b style="color: #5f7afc;">Minutes</b>&nbsp;&nbsp;
                                                     <asp:CheckBox ID="CheckBox3" runat="server" Text="Jamming Only" Font-Bold="True"
                                        Font-Names="Verdana" Font-Size="11px" ForeColor="#5F7AFC" Visible="true" TextAlign="Left"
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <div style="font-family: Verdana; font-size: 11px;">
                                        ...
                                        <asp:Label ID="lblmessage2" runat="server" ForeColor="Red" Text="V- Invalid Data, E- Error"
                                            Visible="False"></asp:Label>
                                        <br />
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Ignition" HeaderText="Ignition">
                                                 ...
                                                 <asp:BoundField DataField="PTO" HeaderText="PTO">
                                                  ...
                                                  <asp:BoundField DataField="Jaming" HeaderText="Jaming">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>

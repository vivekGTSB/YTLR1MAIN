<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.SuperUserManagement" Codebehind="SuperUserManagement.aspx.vb" %>
                                ...
                                <tr>
                                    <td style="width: 450px; border: solid 1px #3952F9;">
                                        <table style="width: 450px;">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Super Users :</b>
                                                </td>
                                                <td align="left" colspan="2">
                                                    <asp:DropDownList ID="ddluser" runat="server" Width="250px" AutoPostBack="True">
                                                        <asp:ListItem>--Select Super User--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>

...
Partial Class VehicleViolationMonthlyReportGroup
    ...
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        Try
            ...
            Dim noofmonths As Int16
            If userid = 2884 Then
                noofmonths = 36
            Else
                noofmonths = 13
            End If
            For i As Int16 = 0 To noofmonths
                ...
                ddlyear.Items.Add(New ListItem(yearmonth, Year(DateAdd(DateInterval.Month, -i, Date.Now)).ToString() & "-" & Month(DateAdd(DateInterval.Month, -i, Date.Now)).ToString()))
            Next
            ddlyear.Value = Curyearmonth

<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.SuperServiceMangement" Codebehind="SuperServiceMangement.aspx.vb" %>
    ...
    <link href="cssfiles/jquery.ui.dialog.css" rel="stylesheet" type="text/css" /> 
     <script type="text/javascript" >
        function refreshTable() {
             ...
             $.getJSON('ServiceingJsonT.aspx?u=1967&role=Admin&opr=0&r=' + Math.random(), null, function (json) {
         ...
         $(document).ready(function () {
             ...
             oTable = $('#example').dataTable({
                 ...
                 { "sClass": "left", "aTargets": [2], "sType": "num-html", "bSortable": true, "sWidth": "60px", "asSorting": ["desc", "asc"] ,"fnRender": function (oData, sVal) {
                    return "<span style='cursor:pointer;color:blue;' onclick='javascript:Getticketdetails(\"" + oData.aData[2] + "\")'>" + oData.aData[2] + "</span>";
                 }
                 },
                 { "sClass": "left", "bVisible": true, "sWidth": "100px", "bSortable": true, "aTargets": [3] },
                 { "sClass": "left", "bVisible": true, "sWidth": "80px", "bSortable": true, "aTargets": [4] },
...
//                 }
//                 },
                 {"sClass": "left", "aTargets": [8], "sType": "html", "bVisible": true, "bSortable": true, "sWidth": "50px", "fnRender": function (oData, sVal) {
                     if (oData.aData[7] == 'Open') {
                         return "<span style='cursor:pointer;color:blue;' onclick='javascript:Getticketdetails(\"" + oData.aData[10] + "\")'>Assign</span>";
                     }
                     else {
                         return "<span style='cursor:pointer;color:blue;' onclick='javascript:Getticketdetails(\"" + oData.aData[10] + "\")'>View</span>";
                     }
                 }
                 }
               ]
         ...
         function serviceassign() {
             ...
             if (assign == "") {
                 ...
                 $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&asto=' + $("#txtaasign").val() + '&remarks=' + $("#txtdescri").val() + '&opr=5&r=' + Math.random(), null, function (json) {
                     if (json.d == 1) {
          ...
          function Getticketdetails(serviceid) {
             ...
             $.getJSON('ServiceingJsonT.aspx?serviceid=' + serviceid + '&u=' + $("#hidloginuser").val() + '&opr=2&r=' + Math.random(), null, function (json) {
                 if (json.length == 1) {
         ...
         function sendcomment() {
             ...
             if (cmt == "") {
                 ...
                 $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&u=' + $("#hidloginuser").val() + '&Comment=' + $("#txtcomment").val() + '&opr=3&r=' + Math.random(), null, function (json) {
                     if (json.d == 1) {
                         $("#txtcomment").val("");
                         GetComments(0)
                     }
         ...
         function GetComments(st) {
             $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&st=' + st + '&opr=4&r=' + Math.random(), null, function (json) {
         ...
         function closeservice() {
          ...
          $("#dialog-confirm").dialog({
              close: function (event, ui) {
                  if (confirmresult) {
                      $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&u=' + $("#hidloginuser").val() + '&opr=6&r=' + Math.random(), null, function (json) {
                          if (json.d == 1) {
      ...
      function reopenservice() {
          ...
          $("#dialog-confirm").dialog({
              close: function (event, ui) {
                  if (confirmresult) {
                      $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&u=' + $("#hidloginuser").val() + '&opr=9&r=' + Math.random(), null, function (json) {
                          if (json.d == 1) {
      ...
      function changeservicedate() {
          ...
          if (dt == "") {
             ...
             $("#dialog-confirm").dialog({
                 close: function (event, ui) {
                     if (confirmresult) {
                         $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&srvdt=' + $("#txtserdate").val() + '&u=' + $("#hidloginuser").val() + '&opr=8&r=' + Math.random(), null, function (json) {
                             if (json.d == 1) {
      ...
      function Receiveservice() {
          ...
          $("#dialog-confirm").dialog({
              close: function (event, ui) {
                  if (confirmresult) {
                      $.getJSON('ServiceingJsonT.aspx?serviceid=' + $("#serviceid").val() + '&u=' + $("#hidloginuser").val() + '&opr=7&r=' + Math.random(), null, function (json) {
                          if (json.d == 1) {
...
<body>
    ...
    <center>
     ...
     <br />
       ...
       <tr><td colspan ="2">
         <table width="1200" cellpadding="0" cellspacing="0" border="0" align="center" class="display" id="example" style="font-size: 11px; font-family: verdana">

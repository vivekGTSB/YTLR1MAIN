<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.VehicleOverspeedReport" Debug="true" Codebehind="VehicleOverspeedReport.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Vehicle Overspeed Report</title>
 ...
 <link rel="stylesheet" href="cssfiles/css3-buttons.css" type="text/css" media="screen"/>
      ...
      <script type="text/javascript" language="javascript">
          $(function () {
              $("#txtBeginDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: -420, maxDate: -1, changeMonth: true, changeYear: true, numberOfMonths: 2
              });

              $("#txtEndDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: -420, maxDate: -1, changeMonth: true, changeYear: true, numberOfMonths: 2
...
<br />
                <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Vehicle Overspeed Report</b>&nbsp;<br />
                <br />
                <table>
                    <tr>
                        <td align="center">
                            <table style="font-family: Verdana; font-size: 11px;">
                                <tr>
                                    <td style="height: 20px; background-color: #465ae8;" align="left">
                                        <b style="color: White;">&nbsp;Vehicle Overspeed Report &nbsp;:</b></td>
                                </tr>
                                <tr>
                                            ...
                                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" EnableViewState="False" OnRowDataBound="GridView2_RowDataBound"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="No" HeaderText="No" HtmlEncode="False">
                                                     ...
                                                     <asp:BoundField DataField="VehicleGroup" HeaderText="Vehicle Group" HtmlEncode="False">
                                                        <ItemStyle Width="140px" HorizontalAlign="Center" Font-Bold="False" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PlateNo" HeaderText="Plate No." HtmlEncode="False">
                                                        <ItemStyle Width="140px" HorizontalAlign="Center" Font-Bold="False" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="DateTime" HeaderText="Date Time" HtmlEncode="False">
                                                        <ItemStyle Width="130px" HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Speed" HeaderText="Speed (kmph)" HtmlEncode="False">
                                                        <ItemStyle Width="130px" HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Address" HeaderText="Address" HtmlEncode="False">
                                                        <ItemStyle HorizontalAlign="left" />
                                                    </asp:BoundField> 
                                                   <asp:BoundField DataField="Latitute" HeaderText="Latitude" HtmlEncode="False">
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:BoundField>  
                                                    <asp:BoundField DataField="Longitude" HeaderText="Longitude" HtmlEncode="False">
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:BoundField>
                                                </Columns>
    ...
    <form id="excelform" method="get" action="ExcelReport.aspx">
        <input type="hidden" id="title" name="title" value="Vehicle Overspeed Report" />

    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ElseIf role = "SuperUser" Or role = "Operator" Then
                cmd = New SqlCommand("select u.userid, u.username,g.groupname from userTBL u join vehicle_group g on u.userid=g.userid and u.userid in (" & userslist & ") order by u.username desc,g.groupname", conn)
                cmd2.CommandText = "select plateno,userid from vehicleTBL where userid in(" & userslist & ") order by plateno "
            ElseIf role = "Admin" Then
                cmd = New SqlCommand("select u.userid, u.username,g.groupname from userTBL u join vehicle_group g on u.userid=g.userid and  u.role='User' order by u.username desc,g.groupname", conn)

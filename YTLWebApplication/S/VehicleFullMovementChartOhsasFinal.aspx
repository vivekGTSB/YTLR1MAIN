<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.VehicleFullMovementChartOhsasFinal" Codebehind="VehicleFullMovementChartOhsasFinal.aspx.vb" %>

<%@ Register TagPrefix="chart" Namespace="ChartDirector" Assembly="netchartdir" %>
<%--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">--%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title> Continuous Driving Chart</title>
...
<body style="font-family: Verdana; font-size: 5px;">
    ...
    <center>
        <div>
            <div>
                <br />
                <b style="font-family: Verdana; font-size: 20px; color: #38678B;"> Continuous Driving Chart</b>
                <br />
                <br />
            </div>
            <div runat="server" id="msg" style="position: absolute; left: 10px; top: 50px; text-align: left;">
      <asp:Label ID="Label5" runat="server" Text="For the System to generate the report, the following will be the definition"
                            ...
                            <asp:Label ID="Label6" runat="server" Text="Traveling - Ignition ON and speed > 0"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label><br />
                            <asp:Label ID="l55" runat="server" Text="Idling - Ignition ON and speed = 0 "
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label>
                            <br />
                            <asp:Label ID="Label2" runat="server" Text="Stop - Ignition OFF, regardless of speed"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label>
                            <br />
                            <br />
                            <asp:Label ID="Label3" runat="server" Text="REST Time -    Stop + Idling continuously >= 30minutes OR Stop continuously >= 30minutes OR  Idling continuously >= 30minutes"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label>
                            <br />
                            <br />
                              <asp:Label ID="l66" Text="Continuous Driving > 4Hrs" runat="server" ForeColor="Blue"  Font-Size="13px" Font-Names="verdana"/><br />
                              <asp:Label ID="Label4" runat="server" Text="Vehicle must REST for >= 30minutes before the 4hrs violation is reach. Any non-continuous stop + Idling < 30min will not be considered as REST"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label><br />
                            <asp:Label ID="Label9" runat="server" Text="If vehicle travel for 03:59 hr and start to REST for >= 30min, then no violation is counted because the vehicle already started to REST before 4hr "
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label>
                            <br />
                            <asp:Label ID="Label12" runat="server" Text="If vehicle travel for 03:59 hr and start to Idling or STOP < 30min then 1 violation is counted."
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label>
                            <br />
                              <asp:Label ID="Label16" runat="server" Text="If vehicle travel for 08:00 hr, then 2 violation count is recorded"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label>
                            <br />
                            <br />
            ...
            <table>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp;  Continuous Driving Chart&nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
                                <td style="border: solid 1px #3952F9;">
                ...
                <tr align="left">
                    ...
                    <asp:Label ID="lblid" runat="server" style="font-size:large;"></asp:Label>
                        
                     <asp:GridView ID="GridView1" runat="server" BackColor="White" 
            BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
            EnableModelValidation="True" AutoGenerateColumns="False" GridLines="Vertical" >
            ...
            <asp:BoundField HeaderText="Status" DataField="Status"/>
              <asp:BoundField HeaderText="Duration (Mins)" DataField="duration" HtmlEncode="false" />
                <asp:BoundField HeaderText="From" DataField="Start"/>
                  <asp:BoundField HeaderText="To" DataField="End"/>
            </Columns>
    </asp:GridView>
    ...
    <input type="hidden" id="title" name="title" value="Vehicle Full Movement Chart" />
    </form>
</body>
<script type="text/javascript">
    function setDIV(id, cmd, cmd1) {
        if (document.getElementById) {  //IE 5.x or NS 6.x or above
            document.getElementById(id).style.visibility = cmd;
            document.getElementById(id).style.display = cmd1;
        }
        else if (document.all) {  //IE 4.x 
            document.all[id].style.visibility = cmd;
            document.all[id].style.display = cmd1;
        }
        else {   //Netscape 4.x
            document[id].visibility = cmd;
            document[id].display = cmd1;
        }
    } 
</script>
</html>

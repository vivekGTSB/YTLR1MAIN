<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.VehicleIdlingChart" Codebehind="VehicleIdlingChart.aspx.vb" %>
...
<head>
    <title>Vehicle Idling Chart</title>
...
function fullscreen()
{
	...
	{
	   	window.parent.document.getElementById("mainpage").rows="56,*";
...
<body style="font-family: Verdana; font-size: 5px;">
    ...
    <center>
        <div>
            <div>
                <br />
                <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Vehicle Idling Chart
                </b>
                <br />
                <br />
            </div>
            <table>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp; Vehicle Idling Chart &nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <b style="color: #5f7afc; font-family: Verdana; font-size: 11px;">&nbsp;Min&nbsp;:&nbsp;</b>
                                                ...
                                                <td align="left">
                                                    <input style="width: 70px;" readonly="readonly" type="text" value="<%=strEndDate%>"
                                                        id="txtEndDate" runat="server" name="txtEndDate" enableviewstate="false" />&nbsp;<b
                                                            style="color: #5f7afc; font-family: Verdana; font-size: 11px;">&nbsp;Hour&nbsp;:&nbsp;</b>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="font-size: 11px; color: #5f7afc; font-family: Verdana">User Name</b>
                                                </td>
                                                <td>
                                                    <b style="font-size: 11px; color: #5f7afc; font-family: Verdana">:</b>
                                                </td>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlpleate" runat="server" Width="257px" Font-Size="12px" Font-Names="verdana">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc; font-family: Verdana; font-size: 11px;">Idling Limit</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc; font-family: Verdana; font-size: 11px;">:</b>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlidling" runat="server" Font-Size="12px" Font-Names="verdana">
                                                    ...
                                                    &nbsp;&nbsp;&nbsp; <b style="color: #5f7afc; font-family: Verdana; font-size: 11px;">
                                                        Filter Idling List</b>
                                                    <asp:CheckBox ID="cbxidling" runat="server" ToolTip="check to display only idling limit over list" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="2" align="left">
                                                    ...
                                                    <button class="action blue" title="Print" id="Print" runat="server" onclick="javascript:print();">
                                                        Print</button>
                                                    <a href="javascript:download();" class="button"><span class="ui-button-text ">Download</span>
                                                    </a>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <tr align="left">
                    <td align="center" colspan="2">
                        <asp:Literal ID="popupInfo" runat="server"></asp:Literal>
    ...
    <input type="hidden" id="title" name="title" value="Vehicle Idling Chart" />
    </form>

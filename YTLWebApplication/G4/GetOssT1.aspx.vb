...
Partial Class GetOssT1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            SecurityHelper.LogError("GetOssT1 Page_Load error", ex, Server)
    ...
    Protected Function GetJson() As String
        ...
        Try
            ...
            Using conn As New SqlConnection(connstr)
                ...
                Dim bdt As String = DateTime.Now.AddDays(-2).ToString("yyyy/MM/dd") & " 00:00:00"
                Dim edt As String = DateTime.Now.ToString("yyyy/MM/dd") & " 23:59:59"
                ...
                json = ProcessOSST1Data(bdt, edt, platecond, vehicleDict, ShipToNameDict1)
            End Using
    ...
    Private Function ProcessOSST1Data(bdt As String, edt As String, platecond As String, vehicleDict As Dictionary(Of String, String), ShipToNameDict1 As Dictionary(Of String, VehicleTrackedRecord)) As String
        Try
                        ...
                        While dr.Read()
                            Try
                                ...
                                If TransNameDict.ContainsKey(transporterName) Then
                                    ...
                                    r(0) = TransNameDict(transporterName) & requiredDate.ToString("dd")
        ...
        Catch ex As Exception
            WriteLog("ProcessOSST1Data error: " & ex.Message)

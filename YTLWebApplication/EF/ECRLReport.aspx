<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.ECRLReport" Codebehind="ECRLReport.aspx.vb" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#examples').dataTable({
                ...
                "aoColumnDefs": [
                    { "bVisible": true, "bSortable": false, "aTargets": [0, 1, 3, 7, 10, 13, 14] },
                    { "bVisible": true, "bSortable": false, "aTargets": [2], "sWidth": "350px" },
                    { "bVisible": true, "bSortable": false,"sWidth":"135px", "aTargets": [ 4, 5, 6, 8, 9, 11, 12] }
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">ECRL Report</b>
            <br />
            <br />
        </div>
        <table>
                    ...
                    <table style="font-family: Verdana; font-size: 11px;">
                        <tr>
                            <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                <b style="color: White;">&nbsp;ECRL Report&nbsp;:</b>
                            </td>
                        </tr>
                        <tr>
                ...
                <td colspan="3">
                    <div style="width: 1190px;">
                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="examples" style="font-size: 10px; font-weight: normal; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif;">
                                <thead>
                                    <tr>
                            <th colspan="5" class ="aligncenter"></th>
                           
                            <th colspan ="3" class ="aligncenter">1st Shift</th>
                                        <th colspan ="3" class ="aligncenter">2nd Shift</th>
                                         <th colspan ="3" class ="aligncenter">3rd Shift</th>
                                        <th> </th>
...
Grande,Helvetica,Arial,sans-serif">
    ...
    <input type="hidden" id="title" name="title" value="ECRL Report" />
    ...
    <script type="text/javascript" >
        ...
        function Submit() {
            ...
            var bdt = $("#txtBeginDate").val();
            
            $.ajax({
                type: "POST",
                url: "ECRLReport.aspx/GetData",
                data: '{fromd: \"' + bdt + '\"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {

<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.VehicleViolationMonthlyReportGroup" EnableEventValidation="false" Codebehind="VehicleViolationMonthlyReportGroup.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
       <title> Vehicle Violation - Monthly</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function refreshTable() {
            ...
            if ($("#ddlplateno").val() != null) {
                ...
                $('#tdfromto').text("From : " + "01 " + $('#ddlyear option:selected').text() + " 00:00:00 To : " + days + " " + $('#ddlyear option:selected').text() + " 23:59:59");

                $.get("GetViolationDailyReport.aspx?pno=" + $('#ddlplateno').val() + "&op=4&bdt=" + "01 " + $('#ddlyear option:selected').text() + " 00:00:00" + "&edt=" + days + " " + $('#ddlyear option:selected').text() + " 23:59:59"+"&uid=" + $("#ddlusers").val() + "&gid=" + $("#ddlgroup").val() + "", function (response) {
                    ...
                    if (json.length > 1) {
                        ...
                        $("#thcntdrv").text(json[json.length - 1][4]);
                        $("#thTotDrv").text(json[json.length - 1][5]);
                        $("#thTotWork").text(json[json.length - 1][6]);
                        $("#thunsavework").text(json[json.length - 1][7]);
                        $("#thunsafedriv").text(json[json.length - 1][8]);
                        $("#thTotVio").text(json[json.length - 1][9]);
                        $("#thdistance").text(json[json.length - 1][10]);
                        $("#thmidnightcount").text(json[json.length - 1][11]);
...
<body onload="conv()">
   ...
   <%-- <asp:Literal ID="Literal1" Visible="false" runat="server" Text="<%$ Resources:chienvh.language, vvr%>" />
    ...
    <center>
        <br />
         <div class="c1"> Vehicle Violation - Monthly Report</div>
         <br />
         <br />
         ...
         <div class="item normal" style="clear:both; width: 200px; height: 310px;text-align:left;background: -webkit-linear-gradient(top, #FFFFFF 0%,#7589EE 100%);" >
                    	...
                    	Select Month & Year
						<span class="value">
							<select name="ddlyear" id="ddlyear" runat ="server" style="width:200px;" class="dropdown" onchange="onchangeyear()">
                          	</select>
                          </span>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0"  id="examples" style="width:1230px;font-family:Verdana;" class="display" >
                            ...
                            <tfoot align="left" style="height:30px;">
                               <tr style="font-weight: bold;font-size:12px;">
                                   ...
                                   <th style="width: 90px;text-align :right; " id="thunsavework">
                                        
                                    </th>
                                    <th style="width: 90px; text-align :right;" id="thunsafedriv">
                                   ...
                                   <th style="width: 50px;text-align :right; " id="thmidnightcount">
    ...
    <input type="hidden" id="title" name="title" value="Vehicle Violation Monthly Report" />
    <input type="hidden" id="plateno" name="plateno" value="" />
    <input type="hidden" id="titl1" name="titl1" value="Vehicle Violation - Monthly Report" />
    ...
    <input type="hidden" id="pdftitle" name="pdftitle" value="Vehicle Violation Monthly Report" />

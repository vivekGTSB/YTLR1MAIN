<%@ Page Language="vb" AutoEventWireup="false" Inherits="YTLWebApplication.AVLS.AddFuel" Codebehind="AddFuel.aspx.vb" %>
...
function fuelchange(obj)
{
    ...
    switch(obj.value)
    {
     ...
     case "LPG":
        ...
        break;
     case "Petrol":
        document.getElementById("txtonelitercost").value="1.85";
        break;  
     case "Petrol V-Power":
        document.getElementById("txtonelitercost").value="2.10";
        break;
//     default:
//        document.getElementById("txtonelitercost").value="";
//        break;
                            ...
                            <table style="font-family: Verdana; font-size: 11px;">
                                <tr>
                                    <td style="height: 20px; background-color: #465ae8;" align="left">
                                        <b style="color: White;">&nbsp;Add Fuel Details :</b></td>
                                </tr>
                                <tr>
                                        ...
                                        <table style="width: 350px;">
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <b>:</b></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlusername" runat="server" Width="185px" AutoPostBack="True">
                                            ...
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <b>:</b></td>
                                                <td>
                                                    <asp:DropDownList ID="ddlpleate" runat="server" Width="185px">
                                                        <asp:ListItem>--Select User Name--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <%-- <tr align="left">
                                                ...
                                                <td>
                                                    <b>:</b></td>
                                                <td>
                                                    <asp:TextBox ID="tbxdatetime" runat="Server" Style="border-right: #cbd6e4 1px solid;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b>:</b></td>
                                                <td align="left">
                                                    <input type="text" id="tbxdatetime" runat="server" style="width: 85px;"
                                                        enableviewstate="false" />&nbsp;&nbsp; <a href="javascript:ShowCalendar('tbxdatetime', 0, 140);">
                                                            <img alt="Show calendar control" title="Show calendar control" src="images/Calendar.jpg"
                                                                style="border: solid 1px #5f7afc;" />
                                                        </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <b>:</b></td>
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlbh" runat="server" Width="40px" CssClass="dclass" EnableViewState="False">
                                            ...
                                            <tr align="left">
                                                <td>
                                                    <b>Fuel Station Code</b></td>
                                                <td>
                                                    <b>:</b></td>
                                                <td>
                                                    <asp:TextBox ID="tbxstationcode" runat="Server" Style="border: #cbd6e4 1px solid;"
                                                        Width="180px" Text="None" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                            ...
                                            <tr align="left">
                                                ...
                                                <td>
                                                    ...
                                                    <input id="cbxcost" type="radio" onclick="javascript:entercost();"
                                                        title="click to activate total cost" />
                                                </td>
                                            </tr>
                                            <tr align="left">
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <input id="cbxliters" type="radio" onclick="javascript:enterliters();" title="click to activate total liters" checked="CHECKED" />
                                                </td>
                                            </tr>
                                            <tr align="left">
                                                <td>
                                                ...
                                                <td>
                                                    <input id="txtonelitercost" style="border: #cbd6e4 1px solid; width: 180px;" type="text"
                                                        runat="Server" onkeyup="return changeonelitercost();" value="1.80" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">

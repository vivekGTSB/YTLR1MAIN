<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.AddInstantAlertSettings" Codebehind="AddInstantAlertSettings.aspx.vb" %>
...
<body style="font-family: Verdana; font-size: 11px;">
    ...
    <center>
        <br />
        <img alt="Add Instant Alert Settings" src="images/AddInstantAlertSettings.png" />
        <br />
        <br />
        <table width="600px;" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td>
                    <%--<fieldset id="Fieldset4" style="width: 600px; border: solid 1px #D5DFE5; -moz-border-radius: 6px;
                            border-radius: 6px; "">--%>
                        ...
                        <table cellspacing="2px;">
                            ...
                            <tr align="left">
                               ...
                               <tr align="left">
                                ...
                                <td style="width: 407px">
                                    &nbsp;&nbsp;Email :
                                    <input name="chk" type="checkbox" value="24" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web :
                                    <input name="chk" type="checkbox" value="25" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SMS :
                                    <input name="chk" type="checkbox" value="26" />
                                </td>
                            </tr>
                            <tr align="left">
                                <td style="width: 286px">
                                ...
                                <td style="width: 407px">
                                    &nbsp;&nbsp;Email :
                                    <input name="chk" type="checkbox" value="27" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web :
                                    <input name="chk" type="checkbox" value="28" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SMS :
                                    <input name="chk" type="checkbox" value="29" />
                                </td>
                            </tr>
                            <tr align="left">
                                <td style="width: 286px">
                                ...
                                <td style="width: 407px">
                                    &nbsp;&nbsp;Email :
                                    <input name="chk" type="checkbox" value="30" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web :
                                    <input name="chk" type="checkbox" value="31" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SMS :
                                    <input name="chk" type="checkbox" value="32" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                        ...
                        <table>
                            <tr>
                                <td align="left" style="width: 400px">
                                    <br />
                                    <a href="InstantAlertSettingsManagement.aspx">
            ...
            <%-- <tr>
                    <td>
                        <fieldset id="Fieldset5" style="width: 600px;">
                            <legend>Actions</legend>
                            <table width="550px">
                                <tr>
                                    <td align="center">

<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.AdminServiceMangementT" Codebehind="AdminServiceMangementT.aspx.vb" %>
    ...
    <link href="cssfiles/jquery.ui.dialog.css" rel="stylesheet" type="text/css" /> 
     <script type="text/javascript" >
        function refreshTable() {
             ...
             $.getJSON('ServiceingJsonT.aspx?u=' + $("#hidloginuser").val() + '&role=' + $("#hidrole").val() + '&opr=0&r=' + Math.random(), null, function (json) {

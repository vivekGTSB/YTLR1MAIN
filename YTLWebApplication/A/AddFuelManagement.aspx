<%@ Page Language="vb" AutoEventWireup="false" Inherits="YTLWebApplication.AVLS.AddFuelManagement" Codebehind="AddFuelManagement.aspx.vb" %>
...
function fuelchange(obj)
{
    ...
    switch(obj.value)
    {
     case "--Select Fuel Type--":
        ...
        break;
     case "Diesel":
        document.getElementById("txtonelitercost").value=dieselCost;
        break;
     case "LPG":
        document.getElementById("txtonelitercost").value="";
        break;
     case "Petrol":
        document.getElementById("txtonelitercost").value="1.91";
        break;  
     case "Petrol V-Power":
                                            ...
                                            <tr align="left">
                                                ...
                                                <td>
                                                    <input id="txtonelitercost" style="border: #cbd6e4 1px solid; width: 180px;" type="text"
                                                        runat="Server" onkeyup="return changeonelitercost();" value="1.93" /></td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                    <br />

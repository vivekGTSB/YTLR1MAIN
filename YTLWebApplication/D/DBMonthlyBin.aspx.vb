    ...
    Protected Sub FillViolations()
        ...
        Try
            ...
            With DbTable.Columns
                ...
                .Add(New DataColumn("Violations Per 1000Km"))
                .Add(New DataColumn("Speeding Rate"))
                .Add(New DataColumn("Continuous Driving Rate"))
            End With
            Label5.Visible = True
            Label6.Visible = True
            Label7.Visible = True
            ...
            End If
            Dim totalVioCount As Integer = 0
            ...
            If ds.Tables(0).Rows.Count <> 0 Then
                ...
                For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    totalVioCount = Integer.Parse(ds.Tables(0).Rows(i)("overspeed")) + Integer.Parse(Round((ds.Tables(0).Rows(i)("harshDec") / 22))) + Integer.Parse(ds.Tables(0).Rows(i)("totalCont4HourCount"))

                    row(13) = Math.Round(totalVioCount / (Format(ds.Tables(0).Rows(i)("distance"), "0.00") / 1000)).ToString.Replace("NaN", "0")
                    row(14) = Math.Round(Integer.Parse(ds.Tables(0).Rows(i)("overspeed")) / (Format(ds.Tables(0).Rows(i)("distance"), "0.00") / 100)).ToString.Replace("NaN", "0")
                    row(15) = Math.Round(Integer.Parse(ds.Tables(0).Rows(i)("totalCont4HourCount")) / (Format(ds.Tables(0).Rows(i)("distance"), "0.00") / 1000)).ToString.Replace("NaN", "0")

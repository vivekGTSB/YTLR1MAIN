    ...
    Protected Sub FillViolations()
        ...
        Try
            ...
            If ddlUsername.Text = "--ALL User--" Then
                If ddlGroupName.SelectedValue = "0" Then
                ...
                Else
                    strSql = "SELECT u.username,o.plateno, sum(o.overspeed) as overspeed,sum(o.midnightcount) as midnightcount,sum(o.hdec) as harshDec,sum(o.hacc) as harchAcc,sum(o.idling) as idling,sum(o.unstop) as unstop,sum(o.unroad) as unroad,sum(o.banhour) as banhour,sum(o.totalCont4HourCount) as totalCont4HourCount," &
                   "sum(o.contdrive) as contdrive,sum(o.drivehour) as drivehour,sum(o.totalCont4HourDrive) as totalCont4HourDrive,sum(o.totalvio) as totalvio,sum(o.distance) as distance,sum(o.totaldriverhour) as totaldrivehour,sum(o.totalworkhour) as totalworkhour" &
                   " FROM userTBL u inner join vehicleTBL v on u.userid=v.userid inner join ohsas_violation o on v.plateno=o.plateno Where o.timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' and v.groupname='" & ddlGroupName.SelectedValue & "' group by o.plateno,u.username order by u.username,o.plateno"
                End If

            ElseIf ddlUsername.Text = "--ALL Transporters--" Then
                If ddlGroupName.SelectedValue = "0" Then
                    strSql = "SELECT u.username,o.plateno, sum(o.overspeed) as overspeed,sum(o.midnightcount) as midnightcount,sum(o.hdec) as harshDec,sum(o.hacc) as harchAcc,sum(o.idling) as idling,sum(o.unstop) as unstop,sum(o.unroad) as unroad,sum(o.banhour) as banhour,sum(o.totalCont4HourCount) as totalCont4HourCount," &
                   "sum(o.contdrive) as contdrive,sum(o.drivehour) as drivehour,sum(o.totalCont4HourDrive) as totalCont4HourDrive,sum(o.totalvio) as totalvio,sum(o.distance) as distance,sum(o.totaldriverhour) as totaldrivehour,sum(o.totalworkhour) as totalworkhour" &
                   " FROM userTBL u inner join vehicleTBL v on u.userid=v.userid inner join ohsas_violation o on v.plateno=o.plateno Where o.timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' and u.userid in (" & userlist & ") and u.customrole='transporter'  group by o.plateno,u.username order by u.username,o.plateno"
                Else
                    strSql = "SELECT u.username,o.plateno, sum(o.overspeed) as overspeed,sum(o.midnightcount) as midnightcount,sum(o.hdec) as harshDec,sum(o.hacc) as harchAcc,sum(o.idling) as idling,sum(o.unstop) as unstop,sum(o.unroad) as unroad,sum(o.banhour) as banhour,sum(o.totalCont4HourCount) as totalCont4HourCount," &
                  "sum(o.contdrive) as contdrive,sum(o.drivehour) as drivehour,sum(o.totalCont4HourDrive) as totalCont4HourDrive,sum(o.totalvio) as totalvio,sum(o.distance) as distance,sum(o.totaldriverhour) as totaldrivehour,sum(o.totalworkhour) as totalworkhour" &
                  " FROM userTBL u inner join vehicleTBL v on u.userid=v.userid inner join ohsas_violation o on v.plateno=o.plateno Where o.timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' and u.userid in (" & userlist & ") and u.customrole='transporter'  and v.groupname='" & ddlGroupName.SelectedValue & "'  group by o.plateno,u.username order by u.username,o.plateno"
                End If
            ...
            Else
                ...
                Else
                    strSql = "SELECT u.username,o.plateno, sum(o.overspeed) as overspeed,sum(o.midnightcount) as midnightcount,sum(o.hdec) as harshDec,sum(o.hacc) as harchAcc,sum(o.idling) as idling,sum(o.unstop) as unstop,sum(o.unroad) as unroad,sum(o.banhour) as banhour,sum(o.totalCont4HourCount) as totalCont4HourCount," &
                       "sum(o.contdrive) as contdrive,sum(o.drivehour) as drivehour,sum(o.totalCont4HourDrive) as totalCont4HourDrive,sum(o.totalvio) as totalvio,sum(o.distance) as distance,sum(o.totaldriverhour) as totaldrivehour,sum(o.totalworkhour) as totalworkhour" &
                       " FROM userTBL u inner join vehicleTBL v on u.userid=v.userid inner join ohsas_violation o on v.plateno=o.plateno Where u.userid='" & ddlUsername.SelectedValue & "' and o.timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "'  and v.groupname='" & ddlGroupName.SelectedValue & "' group by o.plateno,u.username order by u.username,o.plateno"
                End If
...
#End Region
    Protected Overrides Sub OnInit(ByVal e As System.EventArgs)
        If Page.IsPostBack = False Then
            ...
            Try
                ...
                Dim userlist As String = Request.Cookies("userinfo")("userslist")
                Dim custumrole As String = Request.Cookies("userinfo")("customrole")
                ...
                If role = "SuperUser" And custumrole = "transporter" Then
                    ddlUsername.Items.Add("--ALL Transporters--")
                End If
                ...
                dr.Close()
                If role = "User" Then
                    sqlCmd.CommandText = "select groupname from vehicle_group where userid =" & Userid & "  "
                ElseIf role = "Operator" Or role = "SuperUser" Then
                    sqlCmd.CommandText = "select groupname from vehicle_group where userid in (" & userlist & ")  "
                Else
                    sqlCmd.CommandText = "select groupname from vehicle_group where userid =" & Userid & "  "
                End If
                ...
                ddlGroupName.Items.Add(New ListItem("--All Groups--", "0"))
                While dr.Read()
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            Dim oneYearBackDate As DateTime = Now.Date.AddMonths(-13)
    ...
    Protected Sub ddlUsername_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlUsername.SelectedIndexChanged
        ...
        Try
            If ddlUsername.SelectedValue = "0" Or ddlUsername.SelectedValue = "--ALL Transporters--" Or ddlUsername.SelectedValue = "--ALL User--" Then
                If role = "User" Then
                    cmd = New SqlCommand("select groupname from vehicle_group where userid =" & Userid & " ", conn)
                ElseIf role = "Operator" Or role = "SuperUser" Then
                    cmd = New SqlCommand("select groupname from vehicle_group where userid in (" & userlist & ") ", conn)
                Else
                    cmd = New SqlCommand("select groupname from vehicle_group where userid =" & Userid & " ", conn)
                End If
            Else
                cmd = New SqlCommand("select groupname from vehicle_group where userid =" & ddlUsername.SelectedValue & " ", conn)
            End If
            conn.Open()

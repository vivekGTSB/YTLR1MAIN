<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.DBMonthlyBin" Codebehind="DBMonthlyBin.aspx.vb" %>
...
<body style="margin-left: 5px; margin-top: 0px; margin-bottom: 0px; margin-right: 5px;">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Driver Behavior Report (Monthly)</b>
            <table>
                <tr>
                    <td align="center">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Distance Travel" HeaderText="Distance Travel" HtmlEncode="False"
                                                 ...
                                                 <asp:BoundField DataField="Violations Per 1000Km" HeaderText="Violations Per 1000Km" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="Speeding Rate" HeaderText="Speeding Rate" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="Continuous Driving Rate" HeaderText="Continuous Driving Rate" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                            </Columns>

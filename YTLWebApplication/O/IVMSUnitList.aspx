<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.IVMSUnitList" Codebehind="IVMSUnitList.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IVMS Unit List</title>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function ExcelReport() {
        ...
        function refreshTable() {
            $.get("GetIVMSUnitList.aspx?V="+ $("#ddlunit").val() +"", function (response) {
                var json =response;
...
<body style="font-size: 11px; font-weight: normal; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <input type="hidden" id="title" name="title" value="IVMS Unit List" />
    <input type="hidden" id="titl1" name="titl1" value="IVMS Unit List" />

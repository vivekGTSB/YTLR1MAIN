<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.OperatorManagement" Codebehind="OperatorManagement.aspx.vb" %>
...
function mysubmit()
    {
        if(document.getElementById("ddluser").value=="--Select Operator--")
        {
...
<body style="margin: 0px;">
    <form id="operatorform" runat="server">
        <center>
            <div>
                <br />
                <img alt="Operator Management" src="images/OperatorManagement.jpg" />&nbsp;<br />
                <br />
                <table>
                    <tr>
                        <td align="center">
                            <table style="font-family: Verdana; font-size: 11px;">
                                <tr>
                                    <td style="height: 20px; background-color: #465ae8;" align="left">
                                        <b style="color: White;">&nbsp;Operator Management :</b></td>
                                </tr>
                                <tr>
                                    <td style="width: 450px; border: solid 1px #3952F9;">
                                        <table style="width: 450px;">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Operators :</b>
                                                </td>

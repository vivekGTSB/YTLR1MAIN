...
Partial Class OhsasVehicleDaily
...
#Region "Function"
    Protected Sub GetPlateNo(ByVal userid As String)
        ...
        Try
            ...
            If ddlUsername.SelectedValue <> "--Select User Name--" Then
                ...
                Dim strSql As String = "select plateno from vehicleTBL where userid='" & userid & "' order by plateno"
    ...
    Protected Sub FillViolations()
        ...
        Try
            ...
            If ddlVehicle.Text = "--All Vehicle--" Then
                strSql = "SELECT * FROM ohsas_violation Where userid='" & ddlUsername.SelectedValue & "' and timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' order by timestamp,plateno"
            Else
                strSql = "SELECT * FROM ohsas_violation Where userid='" & ddlUsername.SelectedValue & "' and plateno='" & ddlVehicle.SelectedValue & "' and timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' order by timestamp,plateno"
            End If
    ...
    Protected Sub FillViolationsGroupByPlateNo()
        ...
        Try
            ...
            Label12.Enabled = True
            If ddlVehicle.Text = "--All Vehicle--" Then
                strSql = "SELECT * FROM ohsas_violation Where userid='" & ddlUsername.SelectedValue & "' and timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' order by plateno,timestamp"
            Else
                strSql = "SELECT * FROM ohsas_violation Where userid='" & ddlUsername.SelectedValue & "' and plateno='" & ddlVehicle.SelectedValue & "' and timestamp between '" & strBeginDateTime & "' and '" & strEndDateTime & "' order by plateno,timestamp"
            End If
            ...
            If ds.Tables(0).Rows.Count <> 0 Then
                ...
                row(3) = "<font color=""Red""><b>" & maxspeed & "</b></font>"
                row(4) = "<font color=""Red""><b>" & longOSpeedDuration & "</b></font>"
                row(5) = "<font color=""Red""><b>" & Round((harshDec)) & "</b></font>"
                row(6) = "<font color=""Red""><b>" & Round((harshAcc)) & "</b></font>"
                row(7) = "<font color=""Red""><b>" & UnauthStop & "</b></font>"
                row(8) = "<font color=""Red""><b>" & UnauthRoad & "</b></font>"
                row(9) = "<font color=""Red""><b>" & BanHours & "</b></font>"
                row(10) = "<font color=""Red""><b>" & Idle & "</b></font>"

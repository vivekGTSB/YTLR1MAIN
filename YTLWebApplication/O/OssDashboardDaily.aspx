<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.OssDashboardDaily" Codebehind="OssDashboardDaily.aspx.vb" %>
...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#history").datepicker({ dateFormat: 'yy/mm/dd', minDate: -180, maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2, gotoCurrent: true });
        ...
        function LoadJobs() {
            $.ajax({
                type: "GET",
                url: "GetOssDash.aspx?d=" + $('#history').val() + "",
        ...
        function OnLoadJobs(response) {
            ...
            jQuery.each(response.data, function (i, val) {
                var tdNode = $("#" + val[0]);
                // title = "DN NO: " + val[7] + "<br/>Plate No: " + val[2] + "<br/>Patch No: " + val[1] + "<br/>Source: " + val[3] + "<br/>Quantity: " + val[8] + "<br/>Driver: " + val[9] + "<br/>Weight Out Time: " + val[4] + "<br/>Ship To Code: " + val[5] + "<br/>Ship To Name: " + val[6] + "<br/>ATA: " + val[10];
                var sts = "--";
                var s1 = "";
                var s2 = "";
                var sa = "";

<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.OhsasVehicleDailySpeedratings" Codebehind="OhsasVehicleDailySpeedratings.aspx.vb" %>
                ...
                <tr align="left">
                    <td>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="false" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Distance Travel" HeaderText="Distance Travel" HtmlEncode="False"
                                                 ...
                                                 <asp:BoundField DataField="Rating 1 (80 to 84.99)" HeaderText="Rating 1 (80 to 84.99)" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                                  <asp:BoundField DataField="Rating 2 (85 to 89.99)" HeaderText="Rating 2 (85 to 89.99)" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                                  <asp:BoundField DataField="Rating 3 (90 to 94.99)" HeaderText="Rating 3 (90 to 94.99)" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                                  <asp:BoundField DataField="Rating 4 (95 to 99.99)" HeaderText="Rating 4 (95 to 99.99)" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="Rating 5 (>=100)" HeaderText="Rating 5 (>=100)" HtmlEncode="False">
                                                    <ItemStyle Width="80px" HorizontalAlign="Right" ForeColor="Black" />
                                                </asp:BoundField>
                                            </Columns>
                        ...
                        <asp:Label ID="Label15" runat="server" Text="8. Longest Overspeed Duration- The longest continuous period vehicles speed > 80KM/h"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false" Visible="true"></asp:Label><br />
                             <asp:Label ID="Label99" runat="server" Text="9. Rating 1 - Vehicle Speed Between 80 km/hr to 84.99 km/hr"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false" Visible="true"></asp:Label><br />
                             <asp:Label ID="Label16" runat="server" Text="10. Rating 2 - Vehicle Speed Between 85 km/hr to 89.99 km/hr"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false" Visible="true"></asp:Label><br />
                             <asp:Label ID="Label17" runat="server" Text="11. Rating 3 - Vehicle Speed Between 90 km/hr to 94.99 km/hr"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false" Visible="true"></asp:Label><br />
                             <asp:Label ID="Label18" runat="server" Text="12. Rating 4 - Vehicle Speed Between 95 km/hr to 99.99 km/hr"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false" Visible="true"></asp:Label><br />
                             <asp:Label ID="Label19" runat="server" Text="13. Rating 5 - Vehicle Speed >= 100 km/hr "
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false" Visible="true"></asp:Label></br>
                            <asp:Label ID="Label94" runat="server" Text="14. Continuous Driving > 4 Hrs - Number of counts that vehicles is in driving continuous more than 4 Hrs"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label><br />

                            <asp:Label ID="Label92" runat="server" Text="15. Frequency of > 14 Hrs Work - Number of counts from the moment engine started (regardless there is speed or not) until it is turned off is more than 14 Hrs"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label><br />

                            <asp:Label ID="Label93" runat="server" Text="16. Frequency of > 10 Hrs Work - Number of counts from the moment engine started (regardless there is speed or not) until it is turned off is more than 10 Hrs"
                            Font-Size="10px" Font-Names="verdana" ForeColor="Red" Enabled="false"></asp:Label><br />

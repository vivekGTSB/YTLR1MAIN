<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OssDailyDispatchReport.aspx.vb" Inherits="YTLWebApplication.OssDailyDispatchReport" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function ExcelReport() {
            ...
            document.getElementById("title").value = "Daily Dispatch Report - Plant : " + document.getElementById("ddlPlants").value;
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    <form id="Form1" method="post" runat="server">
        <center>
            <div>
                <br />
                <b style="font-family: Verdana; font-size: 20px; color: #38678B;">Dispatch Report</b>
                <br />
                <br />
            </div>
            <table>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp;Dispatch Report&nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
    ...
    <form id="excelform" method="get" action="ExcelReport.aspx">
        <input type="hidden" id="title" name="title" value="Daily Dispatch Report" />

<%@ Page Language="VB" AutoEventWireup="false" Inherits="YTLWebApplication.LafargeGeofenceSummaryReport" Codebehind="LafargeGeofenceSummaryReport.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>YTL Private Geofence Report</title>
    ...
    <script type="text/javascript">
		    ...
		    $(function () {
          $("#txtBeginDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: new Date(2013, 0, 01), maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
          });

          $("#txtEndDate").datepicker({ dateFormat: 'yy/mm/dd', minDate: new Date(2013, 0, 01), maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
...
<body id="index" style="font-size: 11px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Arial,sans-serif">
    ...
    <center>
        <div>
            <br />
            <b style="font-family: Verdana; font-size: 20px; color: #38678B;">YTL Private Geofence Report</b>
            <br />
            <br />
        </div>
        <table>
                    ...
                    <table style="font-family: Verdana; font-size: 11px;">
                        <tr>
                            <td colspan="2" style="height: 20px; background-color: #465ae8;" align="left">
                                <b style="color: White;">&nbsp;YTL Private Geofence Report&nbsp;:</b>
                            </td>
                        </tr>
                        <tr>
    ...
    <input type="hidden" id="title" name="title" value="YTL Private Geofence Report" />

<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.OhsasVehicleMonthlySpeedratings" Codebehind="OhsasVehicleMonthlySpeedratings.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Driver Behavior Report (Monthly)</title>
                                                ...
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlUsername" runat="server" Font-Names="verdana" Font-Size="12px"
                                                        ...
                                                        <asp:ListItem>--ALL User--</asp:ListItem>
                                                           <asp:ListItem>--ALL Transporters--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>

<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="YTLWebApplication.ClientServiceManagement" Codebehind="ClientServiceManagement.aspx.vb" %>
...
<head runat="server">
    ...
    <link href="cssfiles/jquery.ui.dialog.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript">
         $(function () {
            $("#txtserdate").datepicker({ dateFormat: 'yy/mm/dd', minDate: +1, maxDate: +180, changeMonth: true, changeYear: true, numberOfMonths: 2
            });
    ...
    <script language="javascript" type="text/javascript">
            ...
            oTable = $('#example').dataTable({
                ...
                { "sClass": "left", "aTargets": [2], "sType": "num-html", "bSortable": true, "sWidth": "120px", "asSorting": ["desc", "asc"], "fnRender": function (oData, sVal) {
                    ...
                    if (oData.aData[17] == 0)
                        ...
                        return "<span style='cursor:pointer;color:blue;' title='" + oData.aData[17] + " Unread Comments, Click to Read' onclick='javascript:Getticketdetails(\"" + oData.aData[2] + "\")'>" + oData.aData[2] + "</span><div class='badge'>" + oData.aData[17] + "</div>";

                }
                },
                 { "sClass": "left", "bVisible": true, "sWidth": "200px", "bSortable": true, "aTargets": [3] },
                  { "sClass": "left", "bVisible": true, "sWidth": "200px", "bSortable": true, "aTargets": [4], "fnRender": function (oData, sVal) {
                      if (oData.aData[4] == null || oData.aData[4] == "--") {
                          oData.aData[4] = "";
                          return "<span style='cursor:pointer;color:blue;' onclick='javascript:openupdateticket(\"" + oData.aData[5] + "\",\"" + oData.aData[7] + "\",\"" + oData.aData[8] + "\",\"" + oData.aData[14] + "\",\"" + oData.aData[15] + "\",\"" + oData.aData[16] + "\",\"" + oData.aData[13] + "\",\"" + oData.aData[12] + "\")'>--</span>";
                      } else {
                          return "<span style='cursor:pointer;color:blue;' onclick='javascript:openupdateticket(\"" + oData.aData[5] + "\",\"" + oData.aData[7] + "\",\"" + oData.aData[8] + "\",\"" + oData.aData[14] + "\",\"" + oData.aData[15] + "\",\"" + oData.aData[16] + "\",\"" + oData.aData[13] + "\",\"" + oData.aData[12] + "\")'>" + oData.aData[4] + "</span>";
                      }
                  }
                  },
                   { "sClass": "left", "bVisible": true, "sWidth": "80px", "bSortable": true, "aTargets": [5] },
                    { "sClass": "left", "bVisible": true, "sWidth": "100px", "bSortable": true, "aTargets": [6] },
                     { "sClass": "left", "bVisible": true, "sWidth": "120px", "bSortable": true, "aTargets": [7] },
                       { "sClass": "left", "bVisible": true, "sWidth": "80px", "bSortable": true, "aTargets": [8] },
                       { "sClass": "left", "bVisible": true, "sWidth": "140px", "bSortable": true, "aTargets": [9] },
                       { "sClass": "left", "bVisible": true, "sWidth": "120px", "bSortable": true, "aTargets": [10] }
        ...
        function updateticket() {
            var res = mysubmit();
            if (res == true) {
                $.getJSON('ServiceingJsonT1.aspx?u=' + $("#hidserviceid").val() + '&opr=10&p=' + $("#ddlplatenumbers").val() + '&stype=' + $("#servicetype").val() + '&pre=' + $("#ddlpriority").val() + '&expdt=' + $("#txtserdate").val() + ' ' + $("#ddlbh").val() + ':' + $("#ddlbm").val() + '&rem=' + encodeURIComponent($("#txtdescri").val()) + '&r=' + Math.random(), null, function (json) {
                    if (json.d == 1) {
        ...
        function Insertticketinformation() {
            ...
            var res = mysubmit();
            if (res == true) {
                $.getJSON('ServiceingJsonT1.aspx?u=' + $("#hidloginuser").val() + '&opr=1&p=' + $("#ddlplatenumbers").val() + '&stype=' + $("#servicetype").val() + '&pre=' + $("#ddlpriority").val() + '&expdt=' + $("#txtserdate").val() + ' ' + $("#ddlbh").val() + ':' + $("#ddlbm").val() + '&rem=' + encodeURIComponent($("#txtdescri").val()) + '&r=' + Math.random(), null, function (json) {
                    if (json.d == 1) {
                        $("#dialog-message").dialog("close");
                    }
                });
        ...
        function mysubmit() {
            ...
            else if (document.getElementById("ddlpriority").value == "") {
                alertbox("Please select priority");
                return false;
            }
        ...
        function sendcomment() {
            ...
            if (comment != "") {
                ...
                $.getJSON('ServiceingJsonT1.aspx?serviceid=' + $("#serviceid").val() + '&u=' + $("#hidloginuser").val() + '&Comment=' + encodeURIComponent(comment) + '&opr=3&r=' + Math.random(), null, function (json) {
                    if (json.d == 1) {
                        $("#txtcomment").val("");
                        GetComments(0)
                    }
...
<body>
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: right; padding-right: 0px;">
                        <a style="cursor: pointer;" class="button" onclick="javascript:openNewticket()">Add
                            New</a>
                    </td>
                </tr>
                <tr>
    ...
    <div id="dialog-message" style="padding-top: 1px; padding-right: 0px; padding-bottom: 0px;
        font-size: 11px; padding-left: 0px; font-weight: bold; font-family: Myriad Pro,Lucida Grande,Helvetica,Verdana,sans-serif;">
        <br />
        <div class="table info_box" style="width: 500px;">
            <table width="width:500px;" style="padding-left: 10px; font-size: 11px; font-family: verdana;
                font-weight: bold; color: #4E6CA3;">
                <tr align="left">
                    <td>
                        Plate No
                    </td>
                ...
                <tr align="left">
                    ...
                    <td>
                        <select id="servicetype" class="dropdown1 ">
                            <option>Data Lost</option>
                            <option>PTO Faults</option>
                            <option>Power Cut</option>
                            <option>Panic Faults</option>
                            <option>GPS Invalid Location</option>
                            <option>Data Delay</option>
                ...
                <tr align="left">
                    ...
                    <td>
                        <select id="ddlpriority" class="dropdown1">
                            <option>LOW </option>
                ...
                <tr align="left">
                 ...
                 <tr align="left">
                    <td colspan="3" style ="color :Red ;">
                        * kindly specify the service location in Remarks Column is applicable
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div id="div-ticket" style="padding-top: 1px; padding-right: 0px; padding-bottom: 0px;
        font-size: 11px; padding-left: 0px; font-family: Myriad Pro,Lucida Grande,Helvetica,Verdana,sans-serif;">
        <br />
                        ...
                        <table class="hor-minimalist-b" id="tblservicedetails">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td id="tdServiceddate" colspan="4">
                                </td>
                            </tr>
                            <tr>
                                <td>
